...
function incrementarPorUno(array) {
   ...
   //return array.map + 1;
   //var array2=[];
     let array2 = array.map(function incrementarPorUno(array) {
      return array +1; 
     });
     return array2;
   }
...
function agregarNumeros(arrayOfNums) {
   ...
   // Tu código:
   const suma1 = arrayOfNums.reduce((valorAnterior, valorActual)=>{
...
function promedioResultadosTest(resultadosTest) {
   ...
   // Tu código:
   const suma1 = resultadosTest.reduce((valorAnterior, valorActual)=>{
      return valorAnterior + valorActual;
   }, 0);
